	...
	public function index(): string {
		...
		foreach ($products as $product) {
			...
			if ($product['subscription']) {
				...
				// Add trial tax if trial price exists
				if (isset($product['subscription']['trial_price'])) {
					$subscription_data['trial_tax'] = $this->tax->getTax($product['subscription']['trial_price'], $product['tax_class_id']);
				}
				
				// Add tax if price exists
				if (isset($product['subscription']['price'])) {
					$subscription_data['tax'] = $this->tax->getTax($product['subscription']['price'], $product['tax_class_id']);
				}
			}
		...
		foreach ($products as $product) {
			...
			// Add subscription options data similar to cart
